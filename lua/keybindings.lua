...
map("n", "<Space>s", "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>", {desc = "Goto Symbol (Workspace)"})
map("n", "<Space>e", "<cmd>lua vim.diagnostic.open_float()<cr>", {desc = "Expands Error"})
map("n", "ge", "<cmd>GoImplements<cr>", {desc = "Goto implementation"})
